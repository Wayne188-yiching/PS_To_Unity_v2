...
namespace PhotoshopToUnity.EditorImporter
{
    public static class LayoutReader
    {
        ...
        private const string HighestSupportedSchemaVersion = "2.11";
        ...
        private static PhotoshopUiNode ParseNode(Dictionary<string, object> source)
        {
            return new PhotoshopUiNode
            {
                ...
                fauxBold = GetBool(source, "fauxBold", false),
                textInsetLeft = GetFloat(source, "textInsetLeft"),
                textInsetTop = GetFloat(source, "textInsetTop"),
                textInsetRight = GetFloat(source, "textInsetRight"),
                textInsetBottom = GetFloat(source, "textInsetBottom"),
                ...
                scrollbarDirection = GetString(source, "scrollbarDirection"),
                scrollbarRole = GetString(source, "scrollbarRole"),
                maskMode = GetString(source, "maskMode"),
                maskRole = GetString(source, "maskRole"),
