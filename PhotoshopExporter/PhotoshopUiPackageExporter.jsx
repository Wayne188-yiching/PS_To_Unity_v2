...
function showExportDialog(doc) {
    ...
    // Opening the window must be instant, so the selection is only read lazily, right
    // below, when the user actually turns this checkbox on (not at window-open time).
    var selectedSummaryLabel = optionPanel.add("statictext", undefined,
        "勾選後即讀取並顯示目前選取的文字圖層（開啟視窗時不會預先掃描 PSD）");
...
// with equivalent sort semantics; kept as a single definition after merging the two lines.
